...
if($c_character->saveDataFromLobby($room_id,getCharDataFromLobbyServer($char_id,$principal_id,$principal_ip,(empty($_COOKIE['room_token'])?'':$_COOKIE['room_token'])),$forced_load_flag)){
	// キャラクター画像データの読み込み
	$image_list=array();
